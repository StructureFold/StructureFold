#!/usr/bin/env python
#David Tack
#Part of a set of tools to simplfy use of Structure Fold
...
def generate_stitched_file():
    '''Itterate through the directory, read in all the PPVs and sensitivies'''
    x_dict = {}
    os.chdir('Out')
...
if __name__ == '__main__':
    print ''
    print '\033[1;4;94mStructure Fold:\033[0;0;92m generate_PPV.py\033[0m'
    print ''
    parser = argparse.ArgumentParser(description='Generate PPV compares two directories of .ct files and calculates PPV and Sensitivity between transcript structures.')
    parser.add_argument("accepted", type=str, help="Accepted Structure Directory")
    parser.add_argument("predicted", type=str, help="Predicted Structure Directory")
